...
class WorldTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStepMultiplayer()
    {
        $w = new World(5, 10);
        ...
        $this->assertEquals('E', (string)$w->cellAt(2, 2));
        $this->assertEquals('E', (string)$w->cellAt(2, 3));
        $this->assertEquals('E', (string)$w->cellAt(2, 4));

        // No one should be born.
        $this->assertEquals('E', (string)$w->cellAt(1, 3));
        $this->assertEquals('E', (string)$w->cellAt(3, 3));
    }
